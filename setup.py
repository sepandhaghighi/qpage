...
def sample_handler():
    response=input("Press [S] to enter sample site material runing or other keys to continue with your data") # Get Input form user for loading sample files or continue
